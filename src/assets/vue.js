var Vue = (function (exports) {
  ...
  function setDevtoolsHook(hook, target) {
    ...
    if (exports.devtools) {
      ...
      window.HTMLElement &&
      // also exclude jsdom
      !((_b = (_a = window.navigator) === null || _a === void 0 ? void 0 : _a.userAgent) === null || _b === void 0
        ? void 0
        : _b.includes('jsdom'))
    ) {
  ...
  */
    ...
    const unmount = (vnode, parentComponent, parentSuspense, doRemove = false, optimized = false) => {
      ...
      if (shapeFlag & 6 /* COMPONENT */) {
        ...
        if (shapeFlag & 64 /* TELEPORT */) {
          ...
          (type === Fragment && patchFlag & (128 /* KEYED_FRAGMENT */ | 256) /* UNKEYED_FRAGMENT */) ||
  ...
  function genFunctionPreamble(ast, context) {
    const { ssr, prefixIdentifiers, push, newline, runtimeModuleName, runtimeGlobalName, ssrRuntimeModuleName } =
      context;
    ...
    if (!onComponentSlot) {
      ...
      if (!hasTemplateSlots) {
        ...
        if (hasNamedDefaultSlot) {
          context.onError(
            createCompilerError(39 /* X_V_SLOT_EXTRANEOUS_DEFAULT_SLOT_CHILDREN */, implicitDefaultChildren[0].loc)
          );
        } else {
      ...
      if (prop.type === 6 /* ATTRIBUTE */) {
        ...
        if (name === 'ref') {
          ...
          if (context.scopes.vFor > 0) {
            properties.push(
              createObjectProperty(createSimpleExpression('ref_for', true), createSimpleExpression('true'))
            );
          }
        }
        ...
        if (!arg && (isVBind || isVOn)) {
          ...
          if (exp) {
            ...
            context.onError(
              createCompilerError(isVBind ? 34 /* X_V_BIND_NO_EXPRESSION */ : 35 /* X_V_ON_NO_EXPRESSION */, loc)
            );
          }
          continue;
        }
  ...
  function hasMultipleChildren(node) {
    ...
    const children = (node.children = node.children.filter(
      c => c.type !== 3 /* COMMENT */ && !(c.type === 2 /* TEXT */ && !c.content.trim())
    ));
    const child = children[0];
    return (
      children.length !== 1 ||
